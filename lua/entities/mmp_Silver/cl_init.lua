...
function ENT:DrawTranslucent()
    ...
    --self:SetColor(HSVToColor( CurTime() * 65 % 360, 1, 0.35 ))
    ...
    if imgui.Entity3D2D(self, Vector(-16, -15, 10.8), Angle(0, 90, 0), 0.1) then
        ...
        draw.SimpleText( string.format("$%u / $%u", self:GetNWInt( "pStorage" ), self:GetNWInt( "pMaxStorage" ) ), "Mephistum_Small", 187.5, 95, Color( 255, 255, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
